...
class Products {
  ...
  render() {
    ...
    CATALOG.forEach(({ id, labelsale, labelnew, image, name, sort, price, price2 }) => {
      htmlCatalog += `<div class="item-product">` +
        ...
        `</div>
              ...
              <a href="#" class="item-product__button btn_white" onclick="productsItems.addProductToCart(this, '${id}')">Add to cart</a>
